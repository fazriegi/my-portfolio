const Card = ({ title, description, programmingLang, link }) => {
  return (
    <a href={link} target="_blank" className="w-full sm:w-[49%] md:w-[45%] lg:w-5/12 xl:w-[45%] 2xl:w-[28%]">
      ...
      <h1 className="text-primary-text text-lg md:text-xl lg:text-2xl font-semibold">{title}</h1>
      <p className="text-primary-text mt-2 text-base md:text-lg">{description}</p>
